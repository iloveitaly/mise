...
Mise supports monorepo-style task organization with Bazel/Buck2-inspired target paths. Enable it by setting `experimental_monorepo_root = true` in your root `mise.toml`.
